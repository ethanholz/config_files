...
globalkeys = gears.table.join(
	...
	end, { description = "run discord", group = "applications" }),
	...
	awful.key({}, "XF86AudioRaiseVolume", function()
		volume_widget:inc(5)
	end, { description = "increase by 5", group = "volume" }),
	awful.key({}, "XF86AudioLowerVolume", function()
		volume_widget:dec(5)
	end, { description = "decrease by 5", group = "volume" }),
	awful.key({}, "XF86AudioMute", function()
		volume_widget:toggle()
	end, { description = "toggle mute", group = "volume" }),
	awful.key({ modkey }, "F1", function()
		-- awful.util.spawn([[pactl set-source-volume alsa_input.pci-0000_21_00.3.analog-stereo 40% > /dev/null]])
